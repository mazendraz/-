/**
 * Canonical API contract shapes — verbatim copy of api/src/lib/apiTypes.ts,
 * same convention app/src/lib/apiTypes.ts already follows (each frontend
 * keeps its own copy; there is no shared package boundary between api/, app/
 * and desktop/). Keep all three in sync by hand; this file is generated by
 * neither build. Services return these shapes; routes serialize Prisma rows
 * into them.
 */

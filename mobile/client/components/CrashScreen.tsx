/**
 * Last-resort screen for when React itself has thrown — the mobile
 * counterpart of the website's CrashScreen.tsx. Rendered by the
 * `ErrorBoundary` exported from app/_layout.tsx (expo-router's own
 * convention: https://docs.expo.dev/router/error-boundaries — exporting
